...
rel_root = lambda path: os.path.realpath(os.path.join(ROOT_DIR, path))
...
class Common(Configuration):
    ...
    #DATABASES = values.DatabaseURLValue('mysql://localhost/{{cookiecutter.project_name}}')
    DATABASES = values.DatabaseURLValue('sqlite:////' + rel_root('{{cookiecutter.project_name}}.sqlite'))
    ...
    #STATIC_ROOT = os.path.dirname(rel_root('staticfiles'))
    STATIC_ROOT = ""
